...
const getAllInventoryProducts = (filters, paginationOptions) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (searchTerm) {
      andConditions.push({
        $or: addIntoInventory_constant_1.InventoryproductSearchableFields.map(
          field => ({
            [field]: {
              $regex: searchTerm,
              $options: 'i',
    ...
    const result = yield addIntoInventory_model_1.InventoryProducts.find(
      whereConditions,
    )
      .sort(sortConditions)
      .skip(skip)
      .limit(limit);
    const total =
      yield addIntoInventory_model_1.InventoryProducts.countDocuments(
        whereConditions,
      );
    return {
      meta: {
...
const addSingleEnventoryProduct = (id, userInfo) =>
  __awaiter(void 0, void 0, void 0, function* () {
    // Find the product by ID
    const product = yield products_model_1.Products.findOne({
      _id: new mongoose_1.Types.ObjectId(id),
    });
    if (product) {
      const existingProduct =
        yield addIntoInventory_model_1.InventoryProducts.findOne({
      ...
      if (existingProduct) {
        ...
        const updatedProduct = Object.assign(
          Object.assign({}, existingProduct.toObject()),
          { quantity: existingProduct.quantity + 1 },
        );
        const result =
          yield addIntoInventory_model_1.InventoryProducts.findOneAndUpdate(
        ...
        const result =
          yield addIntoInventory_model_1.InventoryProducts.create(newProduct);
...
const deleteAllEnventoryProduct = () =>
  __awaiter(void 0, void 0, void 0, function* () {
...
//   }
// };
const getSingleEnventoryProduct = id =>
  __awaiter(void 0, void 0, void 0, function* () {
    const result = yield addIntoInventory_model_1.InventoryProducts.findOne({
      _id: id,
    });
    return result;
  });
const updateSingleEnventoryProduct = (id, payload) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const result =
      yield addIntoInventory_model_1.InventoryProducts.findOneAndUpdate(
        { _id: id },
...
const deleteSingleEnventoryProduct = id =>
  __awaiter(void 0, void 0, void 0, function* () {
    const service =
      yield addIntoInventory_model_1.InventoryProducts.findOneAndDelete({
        _id: id,
      });
    return service;
  });
