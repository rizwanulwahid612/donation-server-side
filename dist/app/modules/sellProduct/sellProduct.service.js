...
const getAllSellProducts = (filters, paginationOptions) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    const result = yield sellProduct_model_1.SellProducts.find(whereConditions)
      ...
      .limit(limit);
    const total =
      yield sellProduct_model_1.SellProducts.countDocuments(whereConditions);
    return {
      meta: {
        page,
        limit,
...
const addSingleSellProduct = (id, dataInven) =>
  __awaiter(void 0, void 0, void 0, function* () {
    // Find the booking by ID
    const SellInventoryProduct =
    ...
    if (SellInventoryProduct) {
      ...
      const updated2 = Object.assign(
        Object.assign(
          {},
          SellInventoryProduct === null || SellInventoryProduct === void 0
            ? void 0
      ...
      if (existingProduct) {
        ...
        const result = yield sellProduct_model_1.SellProducts.findOneAndUpdate(
...
const addSingleDuplicateProduct = (id, data) =>
  __awaiter(void 0, void 0, void 0, function* () {
    // Find the booking by ID
    ...
    const result =
      yield addIntoInventory_model_1.InventoryProducts.create(data);
    return result;
  });
const getSingleSellProduct = id =>
  __awaiter(void 0, void 0, void 0, function* () {
