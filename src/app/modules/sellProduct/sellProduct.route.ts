...
import { SellProductsController } from './sellProduct.controller';
...
router.post(
  ...
  SellProductsController.addSingleSell,
);
router.post(
  '/duplicate/:id',
  // validateRequest(CategoryValidation.postCategory),
  // auth(ENUM_USER_ROLE.SUPER_ADMIN, ENUM_USER_ROLE.ADMIN),
  SellProductsController.addSingleDuplicateProduct,
);
router.get(
  '/:id',
  // auth(
  ...
  // ),
  SellProductsController.getSingleSellProduct,
);
router.get(
  '/',
  // auth(
  ...
  //   ENUM_USER_ROLE.CUSTOMER,
  // ),
  SellProductsController.getAllSellProducts,
);
...
export const SellProductsRoutes = router;
